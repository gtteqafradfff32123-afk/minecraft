...
public class EnchanterScreen extends ContainerScreen<EnchanterContainer> {
    ...
    private static final List<EnchantInfo> ALL_ENCHANTS = Arrays.asList(
        ...
        new EnchantInfo(ModEnchantments.ZOMBIE_VIRUS, ICON_MELEE, COLOR_VERY_RARE, 19),
        new EnchantInfo(ModEnchantments.TITANS_WRATH, ICON_MELEE, COLOR_EPIC, 20),
        new EnchantInfo(ModEnchantments.EXECUTIONER, ICON_MELEE, COLOR_EPIC, 21),
        new EnchantInfo(ModEnchantments.FROSTBITE, ICON_MELEE, COLOR_EPIC, 22),
        new EnchantInfo(ModEnchantments.SOUL_EATER, ICON_MELEE, COLOR_EPIC, 23),
        new EnchantInfo(ModEnchantments.VOID_VORTEX, ICON_RANGED, COLOR_EPIC, 24),
        new EnchantInfo(ModEnchantments.CHRONO_ANCHOR, ICON_RANGED, COLOR_EPIC, 25),
        new EnchantInfo(ModEnchantments.KINETIC_DEFLECTOR, ICON_ARMOR, COLOR_EPIC, 26),
        new EnchantInfo(ModEnchantments.PHASE_RUPTURE, ICON_MELEE, COLOR_EPIC, 27),
        new EnchantInfo(ModEnchantments.CHAOS_PUPPET, ICON_MELEE, COLOR_EPIC, 28),
        new EnchantInfo(ModEnchantments.ABSOLUTE_BLOOD, ICON_MELEE, COLOR_EPIC, 29),
        new EnchantInfo(ModEnchantments.LEVIATHAN_WRATH, ICON_MELEE, COLOR_EPIC, 30),
        new EnchantInfo(ModEnchantments.BLOOD_PACT, ICON_MELEE, COLOR_LEGENDARY, 31),
        new EnchantInfo(ModEnchantments.BLACK_SINGULARITY, ICON_MELEE, COLOR_LEGENDARY, 32),
        new EnchantInfo(ModEnchantments.NECROPOLIS_ECHO, ICON_MELEE, COLOR_LEGENDARY, 33),
        new EnchantInfo(ModEnchantments.SOUL_REAPER, ICON_MELEE, COLOR_LEGENDARY, 34),
        new EnchantInfo(ModEnchantments.CHAOS_DEVOUR, ICON_MELEE, COLOR_LEGENDARY, 35),
        new EnchantInfo(ModEnchantments.SOLAR_FLARE, ICON_RANGED, COLOR_MYTHIC, 36),
        new EnchantInfo(ModEnchantments.NECROTIC_UNDERTOW, ICON_MELEE, COLOR_MYTHIC, 37),
        new EnchantInfo(ModEnchantments.ZEUS_VOLLEY, ICON_RANGED, COLOR_MYTHIC, 38),
        new EnchantInfo(ModEnchantments.PSYCHOTIC_BREAK, ICON_MELEE, COLOR_MYTHIC, 39),
        new EnchantInfo(ModEnchantments.LIMINAL_SLIP, ICON_MELEE, COLOR_MYTHIC, 40),
        new EnchantInfo(ModEnchantments.MEMBRANE_WEAVER, ICON_ARMOR, COLOR_MYTHIC, 41),
        new EnchantInfo(ModEnchantments.TRUTH_DISSOLVER, ICON_MELEE, COLOR_MYTHIC, 42),
        new EnchantInfo(ModEnchantments.ZOMBIE_VIRUS, ICON_MELEE, COLOR_MYTHIC, 42)
    );
